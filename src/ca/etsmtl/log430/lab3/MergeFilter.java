		...
		try 
		{
			...
			while (!done1 || !done2) 
			{
				...
				if (!done2) 
				{
					...
					{
						done2 = true;
						System.out.println("MergeFilter:: input pipe 2 closed.");
						...
						{
							System.out.println("MergeFilter:: Error closing input pipe 2.");
						} // try/catch
					} 
					else 
					{
				...
				if (write1) 
				{
					...
					try 
					{
						System.out.println("MergeFilter:: Sending " + lineOfText1 + " to output pipe.");
						lineOfText1 += "\n";
				...
				if (write2) 
				{
					...
					try 
					{
						System.out.println("MergeFilter:: Sending " + lineOfText2 + " to output pipe.");
						lineOfText2 += "\n";
