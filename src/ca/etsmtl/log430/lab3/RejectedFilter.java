...
public class RejectedFilter extends Thread
{
	 ...
	 * Class Constructor.
	 * 
	 * @param InputPipe1 the first pipe from which the flow came
	 * @param InputPipe2 the second pipe from which the flow came
	 * @param OutputPipe1 the pipe where the flow will go
	 */
	public RejectedFilter(PipedWriter InputPipe1, PipedWriter InputPipe2,
			PipedWriter OutputPipe1)
	{
		try 
		{
			...
			System.out.println("RejectedFilter:: connected to upstream filters.");
		}
		catch (Exception Error) 
		{
			System.out.println("RejectedFilter:: Error connecting input pipes.");
		} // try/catch
		...
		try 
		{
			...
			System.out.println("RejectedFilter:: connected to downstream filter.");
		}
		catch (Exception Error) 
		{
			System.out.println("RejectedFilter:: Error connecting output pipe.");
		} // catch
	} // Constructor
		...
		try 
		{
			...
			while (!done1 || !done2) 
			{
				...
				if (!done1) 
				{
					...
					{
						done1 = true;
						System.out.println("RejectedFilter:: Input pipe 1 closed.");
						...
						{
							System.out.println("RejectedFilter:: Error closing input pipe 1.");
						} // try/catch
				...
				if (!done2) 
				{
					...
					{
						done2 = true;
						System.out.println("RejectedFilter:: input pipe 2 closed.");
						...
						{
							System.out.println("RejectedFilter:: Error closing input pipe 2.");
						} // try/catch
					} 
					else 
					{
				...
				if (write1) 
				{
					...
					try 
					{
						System.out.println("RejectedFilter:: Sending " + lineOfText1 + " to output pipe.");
						lineOfText1 += "\n";
				...
				if (write2) 
				{
					...
					try 
					{
						System.out.println("RejectedFilter:: Sending " + lineOfText2 + " to output pipe.");
						lineOfText2 += "\n";
